--[[
		.\hksc.exe ".\Lua\ZombiesPublicMatches.Lua" -o "C:\Program Files (x86)\Call of Duty Black Ops 4\project-bo4\mods\T8ShieldSupport\Lua\ZombiesPublicMatches.luac"
]]
...
-- Add public matches to Gauntlets, Rush, etc
...
CoD.ZMLobbyButtonsContainer.new = function ( f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9 )
	...
	CoD.EnhPrintInfo("Called", "ZM Button Container")
	self:setRGB(1, 1, 1)
