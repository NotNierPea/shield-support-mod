--[[
		.\hksc.exe ".\Lua\DirectorCustom.Lua" -o "C:\Program Files (x86)\Call of Duty Black Ops 4\project-bo4\mods\T8ShieldSupport\Lua\DirectorCustom.luac"
]]
...
-- Custom Lobby, add shield options there too
...
CoD.directorCustom.new = function ( f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9 )
	...
	--LUI_DebugElement(f1_arg0, f1_arg1, self, ShieldOptionsButtonZM, "ShieldOptionsButtonZM", 10)

	ShieldOptionsButtonZM.id = "ShieldOptionsButtonZM"

	local ShieldOptionsButton = CoD.DirectorPreGameButtonOption.new( f1_arg0, f1_arg1, 0.00, 0.00, 72.98, 419.98, 1.00, 1.00, 14.75 - 185, 61.75 - 185 ) 
	...
	--LUI_DebugElement(f1_arg0, f1_arg1, self, ShieldOptionsButton, "ShieldOptionsButton", 10)
	...
	local HomeOrPlayListFullPC = Engine[@"hash_78DF2E5447F384B9"]()
	...
	HomeOrPlayListFullPC = Engine[@"hash_78DF2E5447F384B9"]()
	...
	StartButton.DirectorCustomStartButton.MiddleText:setText( LocalizeToUpperString( @"hash_0" ) )
	StartButton.DirectorCustomStartButton.MiddleTextFocus:setText( LocalizeToUpperString( @"hash_0" ) )
	StartButton.PlayText:setText( LocalizeToUpperString( @"hash_6DDDA371285672BD" ) )
	StartButton.PlayTextFocus:setText( LocalizeToUpperString( @"hash_6DDDA371285672BD" ) )
	StartButton:appendEventHandler( "on_session_start", function ( f52_arg0, f52_arg1 )
		f52_arg1.menu = f52_arg1.menu or f1_arg0
		CoD.Menu.UpdateButtonShownState( f52_arg0, f1_arg0, f1_arg1, Enum[@"hash_3DD78803F918E9D"][@"hash_3755DA1E2E7C263F"] )
	end )
	StartButton:appendEventHandler( "on_session_end", function ( f53_arg0, f53_arg1 )
		f53_arg1.menu = f53_arg1.menu or f1_arg0
		CoD.Menu.UpdateButtonShownState( f53_arg0, f1_arg0, f1_arg1, Enum[@"hash_3DD78803F918E9D"][@"hash_3755DA1E2E7C263F"] )
	end )
	DirectorLobbyPoseMembersZM = StartButton
	ZMLoadoutPreviewInfo = StartButton.subscribeToModel
	CustomGamesButton = Engine[@"hash_78DF2E5447F384B9"]()
	ZMLoadoutPreviewInfo( DirectorLobbyPoseMembersZM, CustomGamesButton["lobbyRoot.lobbyNav"], function ( f54_arg0, f54_arg1 )
		CoD.Menu.UpdateButtonShownState( f54_arg1, f1_arg0, f1_arg1, Enum[@"hash_3DD78803F918E9D"][@"hash_3755DA1E2E7C263F"] )
	end, false )
	DirectorLobbyPoseMembersZM = StartButton
	ZMLoadoutPreviewInfo = StartButton.subscribeToModel
	CustomGamesButton = Engine[@"hash_78DF2E5447F384B9"]()
	...
	ZMLoadoutPreviewInfo( DirectorLobbyPoseMembersZM, CustomGamesButton["lobbyRoot.privateClient.update"], function ( f56_arg0, f56_arg1 )
		CoD.Menu.UpdateButtonShownState( f56_arg1, f1_arg0, f1_arg1, Enum[@"hash_3DD78803F918E9D"][@"hash_3755DA1E2E7C263F"] )
	end, false )
	DirectorLobbyPoseMembersZM = StartButton
	ZMLoadoutPreviewInfo = StartButton.subscribeToModel
	CustomGamesButton = Engine[@"hash_78DF2E5447F384B9"]()
	ZMLoadoutPreviewInfo( DirectorLobbyPoseMembersZM, CustomGamesButton["lobbyRoot.selectedMapId"], function ( f57_arg0, f57_arg1 )
		CoD.Menu.UpdateButtonShownState( f57_arg1, f1_arg0, f1_arg1, Enum[@"hash_3DD78803F918E9D"][@"hash_3755DA1E2E7C263F"] )
	end, false )
	DirectorLobbyPoseMembersZM = StartButton
	ZMLoadoutPreviewInfo = StartButton.subscribeToModel
	CustomGamesButton = Engine[@"hash_78DF2E5447F384B9"]()
	ZMLoadoutPreviewInfo( DirectorLobbyPoseMembersZM, CustomGamesButton["lobbyRoot.lobbyList.playerCount"], function ( f58_arg0, f58_arg1 )
		CoD.Menu.UpdateButtonShownState( f58_arg1, f1_arg0, f1_arg1, Enum[@"hash_3DD78803F918E9D"][@"hash_3755DA1E2E7C263F"] )
	end, false )
	...
	f1_arg0:AddButtonCallbackFunction( StartButton, f1_arg1, Enum[@"hash_3DD78803F918E9D"][@"hash_3755DA1E2E7C263F"], "ui_confirm", function ( element, menu, controller, model )
		CoD.ReloadOverrides() -- for wz
	...
	DirectorLobbySettingList( DirectorLaboratoryButton, f1_local15["lobbyRoot.lobbyNav"], function ( f74_arg0, f74_arg1 )
		CoD.Menu.UpdateButtonShownState( f74_arg1, f1_arg0, f1_arg1, Enum[@"hash_3DD78803F918E9D"][@"hash_3755DA1E2E7C263F"] )
	end, false )
	...
	CoD.EnhPrintInfo("director custom called")
...
CoD.directorCustom.__onClose = function ( f103_arg0 )
	...
	f103_arg0.ShieldOptionsButtonZM:close()
	f103_arg0.ShieldOptionsButton:close()
end