--[[
		.\hksc.exe ".\Lua\DirectorPrivate.Lua" -o "C:\Program Files (x86)\Call of Duty Black Ops 4\project-bo4\mods\T8ShieldSupport\Lua\DirectorPrivate.luac"
]]
...
-- Private Game, to add game settings like adding bots in private games
...
CoD.directorPrivate.new = function ( f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9 )
	...
	local f1_local8 = DirectorMapGameTypeAndDifficulty
	local f1_local9 = DirectorMapGameTypeAndDifficulty.subscribeToModel
	...
	--self:setRGB(1, 0, 1)
	--CoD.EnhPrintInfo("Called", "Director Private Game")
      CoD.EnhPrintInfo("Called", "Director Private")
