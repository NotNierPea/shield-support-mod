--[[
		.\hksc.exe ".\Lua\CustomSlider.Lua" -o "C:\Program Files (x86)\Call of Duty Black Ops 4\project-bo4\mods\T8ShieldSupport\Lua\CustomSlider.luac"
]]
...
-- used for blackout bots count, party/engine limit count, etc.
CoD.CraftActionSliderEnhShield = InheritFrom( LUI.UIElement )
CoD.CraftActionSliderEnhShield.__defaultWidth = 375
CoD.CraftActionSliderEnhShield.__defaultHeight = 60
CoD.CraftActionSliderEnhShield.new = function ( f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9 )
	local self = LUI.UIElement.new( f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9 )
	self:setClass( CoD.CraftActionSliderEnhShield )
	self.id = "CraftActionSliderEnhShield"
...
CoD.CraftActionSliderEnhShield.__resetProperties = function ( f5_arg0 )
...
CoD.CraftActionSliderEnhShield.__clipsPerState = {
	DefaultState = {
...
CoD.CraftActionSliderEnhShield.__onClose = function ( f13_arg0 )
...
CoD.CraftActionHeaderEnhShield = InheritFrom( LUI.UIElement )
CoD.CraftActionHeaderEnhShield.__defaultWidth = 375
CoD.CraftActionHeaderEnhShield.__defaultHeight = 800
CoD.CraftActionHeaderEnhShield.new = function ( f1_arg0, f1_arg1, f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9 )
	local self = LUI.UIElement.new( f1_arg2, f1_arg3, f1_arg4, f1_arg5, f1_arg6, f1_arg7, f1_arg8, f1_arg9 )
	self:setClass( CoD.CraftActionHeaderEnhShield )
	self.id = "v"
	self.soundSet = "SelectColor"
...
CoD.CraftActionHeaderEnhShield.__onClose = function ( f3_arg0 )
	f3_arg0.text:close()
end