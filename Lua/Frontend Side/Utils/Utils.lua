--[[
		.\hksc.exe ".\Lua\Utils.Lua" -o "C:\Program Files (x86)\Call of Duty Black Ops 4\project-bo4\mods\T8ShieldSupport\Lua\Utils.luac"
]]
...
CoD.ShieldInitLuaFile = function()
	...
	-- requires
	require( "x64:27b70bc94aba2979" )
	require( "lua/shared/luaenum" )

	require( "x64:31bbde4283bb35f8" )
...
CoD.ShowServerToast = function(Description)
	-- play a little sound
	Engine[@"playsound"]( "uin_map_vote" )

	-- show some toast
	CoD.OverlayUtility.ShowToast( "Invite", "Server", Description, "ui_icon_startmenu_option_network" )
end

CoD.LaunchGameFunction = function(Controller)
	CoD.EnhPrintInfo(tostring(Controller))

	Dvar[@"party_minplayers"]:set(1)
	Engine[@"exec"](Engine[@"getprimarycontroller"](), "LobbyLaunchGame")
end

CoD.VM_ReloadMods = function()
	-- shield command
...
CoD.isInteger = function(str)
	return not (str == "" or string.find(str, "%D"))
end

CoD.IsIPAddress = function(str)
...
CoD.IsValidName = function(str)
	return string.find(str, "^[%-%.%w_]+$") ~= nil
end

CoD.IsEmpty = function(s)
	return s == nil or s == ''
end
...
CoD.IsBadGameMode_MP = function(gamemode)
    local GetID = CoD.GameTypeUtility.GetGameTypeValue(gamemode, "uniqueID", -1)
    return BadGamemodes[GetID] == true
end